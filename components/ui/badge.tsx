...
const badgeVariants = cva(
  "inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-semibold transition-all",
  {
    variants: {
      variant: {
        default: "bg-[rgba(199,91,18,0.2)] text-[#F4A261] border border-[rgba(199,91,18,0.3)]",
        mint: "bg-[rgba(47,158,68,0.15)] text-[#2F9E44] border border-[rgba(47,158,68,0.3)]",
        ...
        innovator: "bg-[rgba(199,91,18,0.2)] text-[#F4A261] border border-[rgba(199,91,18,0.3)]",
        ...
        "ai-pioneer": "bg-[rgba(47,158,68,0.15)] text-[#2F9E44] border border-[rgba(47,158,68,0.3)]"
      }
    },
